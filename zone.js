...
export class source extends view {
    ...
    async simplify(driver_source) {
        ...
        switch (driver_source.type) {
            ...
            case 'sql.fuel':
                ...
                const fuel = await exec('database', [driver_source.dbname, false], 'get_sql_data', [driver_source.sql], cwd);
                //
                //Simplify the  fuel
    ...
    async get_data(sql, dbname) {
        ...
        [dbname, false], 'get_sql_data', [sql], cwd);
        //
        ...
        if (this.driver_source.type === 'sql.fuel') {
            ...
            switch (dim) {
                ...
                case 0:
                    ...
                    const fuels = await exec('database', [dbname, false], 'get_sql_data', [mysql], cwd);
                    //
    ...
    async sqlfuel_get_metadata(sql, row_index, dbname) {
        ...
        const result = await exec('database', [dbname, false], 'get_column_metadata', [sql], cwd);
        //
